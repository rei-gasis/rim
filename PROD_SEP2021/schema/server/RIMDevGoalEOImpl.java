...
// ---------------------------------------------------------------------
public class RIMDevGoalEOImpl extends OAEntityImpl {
    public static final int RIMDEVGOALID = 0;
    public static final int LINENO = 1;
    public static final int TRANSACTIONNO = 2;
    public static final int ITEMKEY = 3;
    public static final int DEVELOPMENTGOAL = 4;
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        if (mDefinitionObject == null) {
            mDefinitionObject = 
                    (OAEntityDefImpl)EntityDefImpl.findDefObject("xxup.oracle.apps.per.rim.schema.server.RIMDevGoalEO");
        }
    ...
    public void create(AttributeList attributeList) {
        ...
        if (getRimDevGoalId() == null) {
            OADBTransaction tr = getOADBTransaction();
            setRimDevGoalId(tr.getSequenceValue("XXUP.XXUP_RIM_DEV_GOAL_SEQ"));
        }
    }

    /**Gets the attribute value for RimDevGoalId, using the alias name RimDevGoalId
     */
    public Number getRimDevGoalId() {
        return (Number)getAttributeInternal(RIMDEVGOALID);
    }

    /**Sets <code>value</code> as the attribute value for RimDevGoalId
     */
    public void setRimDevGoalId(Number value) {
        setAttributeInternal(RIMDEVGOALID, value);
    }
    ...
    /**Gets the attribute value for DevelopmentGoal, using the alias name DevelopmentGoal
     */
    public String getDevelopmentGoal() {
        return (String)getAttributeInternal(DEVELOPMENTGOAL);
    }

    /**Sets <code>value</code> as the attribute value for DevelopmentGoal
     */
    public void setDevelopmentGoal(String value) {
        setAttributeInternal(DEVELOPMENTGOAL, value);
    }
    ...
    protected void setAttrInvokeAccessor(int index, Object value, 
        ...
        case ITEMKEY:
            ...
            return;
        case DEVELOPMENTGOAL:
            setDevelopmentGoal((String)value);
            return;
        case SELECTED:
     ...
     */
    public static Key createPrimaryKey(Number rimDevGoalId) {
        return new Key(new Object[]{rimDevGoalId});
    }
}

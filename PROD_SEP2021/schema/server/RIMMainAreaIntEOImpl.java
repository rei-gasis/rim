...
// ---------------------------------------------------------------------
public class RIMMainAreaIntEOImpl extends OAEntityImpl {
    public static final int RIMMAIID = 0;
    public static final int LINENO = 1;
    public static final int TRANSACTIONNO = 2;
    public static final int ITEMKEY = 3;
    public static final int MAINAREAINTEREST = 4;
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        if (mDefinitionObject == null) {
            mDefinitionObject = 
                    (OAEntityDefImpl)EntityDefImpl.findDefObject("xxup.oracle.apps.per.rim.schema.server.RIMMainAreaIntEO");
        }
    ...
    public void create(AttributeList attributeList) {
        ...
        if (getRimMaiId() == null) {
            ...
            setRimMaiId(tr.getSequenceValue("XXUP.XXUP_RIM_MAIN_AREA_INT_SEQ"));
        }
    }

    /**Gets the attribute value for RimMaiId, using the alias name RimMaiId
     */
    public Number getRimMaiId() {
        return (Number)getAttributeInternal(RIMMAIID);
    }

    /**Sets <code>value</code> as the attribute value for RimMaiId
     */
    public void setRimMaiId(Number value) {
        setAttributeInternal(RIMMAIID, value);
    }
     ...
     */
    public static Key createPrimaryKey(Number rimMaiId) {
        return new Key(new Object[]{rimMaiId});
    }
}

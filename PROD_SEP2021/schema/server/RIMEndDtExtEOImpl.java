...
// ---------------------------------------------------------------------
public class RIMEndDtExtEOImpl extends OAEntityImpl {
    public static final int RIMEXTID = 0;
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        if (mDefinitionObject == null) {
            mDefinitionObject = 
                    (OAEntityDefImpl)EntityDefImpl.findDefObject("xxup.oracle.apps.per.rim.schema.server.RIMEndDtExtEO");
        }
    ...
    public void create(AttributeList attributeList) {
        ...
        if (getRimExtId() == null) {
            ...
            setRimExtId(tr.getSequenceValue("XXUP.XXUP_RIM_END_DT_EXT_SEQ"));
        }
        
    }

    /**Gets the attribute value for RimExtId, using the alias name RimExtId
     */
    public Number getRimExtId() {
        return (Number)getAttributeInternal(RIMEXTID);
    }

    /**Sets <code>value</code> as the attribute value for RimExtId
     */
    public void setRimExtId(Number value) {
        setAttributeInternal(RIMEXTID, value);
    }
     ...
     */
    public static Key createPrimaryKey(Number rimExtId) {
        return new Key(new Object[]{rimExtId});
    }
}
